<header class="contenidor-principal">
    <div class="contenidor-secundari">
        ...
        <form action="include/processaRegistre.php" method="post">
            ...
            <div class="contenidor-secundari">
                <label>Contrasenya: </label><input class="campo-formulario" type="password" required name="password">
            </div>
            <div class="contenidor-secundari">
            ...
            <div class="contenidor-secundari">
                <div style="padding: 0 2rem;">
                    <label class="campo-formulario">Continent: </label>
                    <div><label>Europa: </label>
                    <input type="radio" name="continent" value="Europa"></div>
                    <div><label>Àsia: </label>
                    <input type="radio" name="continent" value="Àsia"></div>
                    <div><label>Àfrica: </label>
                    <input type="radio" name="continent" value="Àfrica"></div>
                    <div><label>Amèrica: </label>
                    <input type="radio" name="continent" value="Amèrica"></div>
                    <div><label>Oceania: </label>
                    <input type="radio" name="continent" value="Oceania"></div>
                </div>
            </div>
            <div class="contenidor-secundari">
